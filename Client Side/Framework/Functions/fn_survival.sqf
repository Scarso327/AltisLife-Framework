...
_fnc_food =  {
    if (ULP_Survival_Hunger < 2) then {player setDamage 1; hint "You have starved to death.";}
    else
    {
...
_fnc_water = {
    if (ULP_Survival_Thirst < 2) then {player setDamage 1; hint "You have died from dehydration.";}
    else
    {
