...
CREATE TABLE IF NOT EXISTS `players` (
  ...
  `cop_daily_tasks` text NOT NULL,
  `cop_weekly_tasks` text NOT NULL,
  ...
  `med_daily_tasks` text NOT NULL,
  `med_weekly_tasks` text NOT NULL,
  ...
  `hato_daily_tasks` text NOT NULL,
  `hato_weekly_tasks` text NOT NULL,
  ...
  `civ_daily_tasks` text NOT NULL,
  `civ_weekly_tasks` text NOT NULL,
