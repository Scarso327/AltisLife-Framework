...
[format[
	...
	getPlayerUID _unit, _act, _crime, [[[_handler] call ULP_DB_fnc_mresString, [_note] call ULP_DB_fnc_mresString]] call ULP_DB_fnc_mresArray, [_unit] call ULP_fnc_getFaction
