class CfgSpyGlass {
    ...
    LIFE_Functions[] = {
        ...
        "life_fnc_houseconfig_meta","life_fnc_housemenu","life_fnc_housemenu_meta","ff_fnc_hudsetup","ff_fnc_hudupdate_meta","ff_fnc_hudupdate","ff_fnc_hudsetup_meta","life_fnc_impoundaction","life_fnc_impoundaction_meta","life_fnc_impoundmenu","life_fnc_impoundmenu_meta","ff_fnc_initcivilian","ff_fnc_initcivilian_meta","ff_fnc_initpolice","ff_fnc_initpolice_meta","life_fnc_initgang",
        "life_fnc_initgang_meta","life_fnc_inithouses","life_fnc_inithouses_meta","ff_fnc_initmedic","ff_fnc_initmedic_meta","life_fnc_inventoryclosed","life_fnc_inventoryclosed_meta","life_fnc_inventoryopened","life_fnc_inventoryopened_meta","life_fnc_isdamaged","life_fnc_isdamaged_meta","life_fnc_isnumeric","life_fnc_isnumeric_meta","life_fnc_isuidactive","life_fnc_isuidactive_meta",
        ...
        "life_fnc_settingsmenu_meta","ff_fnc_setupactions","ff_fnc_setupactions_meta","ff_fnc_setupevh","ff_fnc_setupevh_meta","life_fnc_simdisable","life_fnc_simdisable_meta","life_fnc_sirenlights","life_fnc_sirenlights_meta","life_fnc_sounddevice","life_fnc_sounddevice_meta","life_fnc_spawnconfirm","life_fnc_spawnconfirm_meta","life_fnc_spawnmenu","life_fnc_spawnmenu_meta","life_fnc_spawnpointcfg",
        ...
        "ff_fnc_notify", "ff_fnc_notify_meta", "ff_fnc_handlexp", "ff_fnc_handlexp_meta", "ff_fnc_openmenu", "ff_fnc_openmenu_meta", "ff_fnc_switchapp", "ff_fnc_switchapp_meta", "ff_fnc_escapehandle", "ff_fnc_escapehandle_meta", "ff_fnc_onload", "ff_fnc_onload_meta", "ff_fnc_setupmarket", "ff_fnc_setupmarket_meta", "ff_fnc_setupshop", "ff_fnc_setupshop_meta", "ff_fnc_setupvehicle", "ff_fnc_setupvehicle_meta"
    };
    ...
    allowedVariables[] = {
        ...
        {"life_inv_explosive_charge", "SCALAR"}, 
        {"ff_old_xp", "SCALAR"}, 
        {"ff_level", "SCALAR"}, 
        {"ff_xp", "SCALAR"}, 
        {"ff_level", "STRING"}, 
        ...
        {"dp_10", "OBJECT" }, 
        {"dp_11", "OBJECT" }, 
        {"life_inv_empty_fuel_can", "SCALAR" }, 
        ...
        {"life_inv_small_container", "SCALAR" }, 
        {"life_inv_large_container", "SCALAR" }, 
        {"civ_spawn_1", "ARRAY" }, 
