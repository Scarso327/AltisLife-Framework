class CfgVehicleStores {
	...
	class PoliceAir : Base {
		...
		factions[] = { "Police" };
		class Vehicles {
			class B_UAV_01_F { condition = "[""Police_Main"", 8] call ULP_fnc_hasAccess || { [""Police_NPAS"", 1] call ULP_fnc_hasAccess } || { [""Police_SCO19"", 1] call ULP_fnc_hasAccess } || { [""Police_NCA"", 1] call ULP_fnc_hasAccess }"; };
	...
	class Blackmarket : Base {
		...
		conditions = "[""Blackmarket""] call ULP_fnc_hasLicense && { [""Blackmarketer""] call ULP_fnc_hasPerk }";
		class Vehicles {
			class C_Quadbike_01_F {};
			class C_Offroad_01_F {};
