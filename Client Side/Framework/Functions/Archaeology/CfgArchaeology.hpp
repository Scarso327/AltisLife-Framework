class CfgArchaeology {
	class Common {
		...
		rewards[] = {
			...
			{ 0.93, { "CommonMapFragment", 2 } },
			{ 0.95, { "HandSmoothedRunestone", 1 } },
			{ 0.96, { "UncommonMapFragment", 1 } },
	...
	class Rare {
		...
		rewards[] = {
			...
			{ 0.81, { "CommonMapFragment", 3 } },
			{ 0.83, { "UncommonMapFragment", 2 } },
			{ 0.85, { "AncientLedger", 1 } },
			{ 0.88, { "JeweledNecklace", 3 } },
			{ 0.89, { "RareMapFragment", 1 } },
