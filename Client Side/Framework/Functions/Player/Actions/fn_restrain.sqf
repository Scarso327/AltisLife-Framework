...
if !(local _target) exitWith {
	if ([_detainer, ["Police", "Civilian"]] call ULP_fnc_isFaction && { [player, ["Police"]] call ULP_fnc_isFaction || ["Ziptie", 1, true] call ULP_fnc_handleItem || ["cuffCourier"] call ULP_fnc_hasPerk }) then {
