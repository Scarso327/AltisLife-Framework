...
if (isNil {group player getVariable "gang_name"}) exitWith {titleText["You must create a group first before capturing it!","PLAIN"];};
if (_group == group player) exitWith {titleText["Your group already has control over this hideout!","PLAIN"]};
...
if (!isNull _group) then {
    ...
    _action = [
        format ["This hideout is controlled by %1.&lt;br/&gt;&lt;br/&gt;Are you sure you want to take over their hideout?",_gangName],
...
[[0,1],"%1 and his group: %2 - have taken control of a local hideout!",true,[name player,(group player) getVariable "gang_name"]] remoteExecCall ["life_fnc_broadcast",RCLIENT];
