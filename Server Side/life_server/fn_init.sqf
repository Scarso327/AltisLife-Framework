...
private _routines = ["resetVehicles", "deleteOldGroups", "deleteOldHouses", "deleteOldWarrants", "sortPremiumGroups", "deleteOldBaseBids", "deleteOldMail", "resetWoundedPlayers", "deleteOldAlliances"];
...
if !(ULP_SRV_Setting_Day isEqualTo _date) then { _routines append ["resetDailyGoals", "processPlaytime"]; };
