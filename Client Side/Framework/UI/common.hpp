...
class Life_RscVideo: life_RscPicture
{
	autoplay=1;
	loops=1;
};
...
class ULP_RscMainMenuSpotlight: Life_RscControlsGroupNoScrollbars
{
    fade=1;
	x="0.5 - (2 * 10) * (pixelW * pixelGridNoUIScale * 2) - (4 * pixelW)";
	...
	class Controls
	{
		class GroupPicture: Life_RscControlsGroupNoScrollbars
		{
			x=0;
			y=0;
			w="10 * 	(pixelW * pixelGridNoUIScale * 2)";
		...
		class GroupHover: Life_RscControlsGroupNoScrollbars
		{
			idc=1025;
			fade=1;
			x=0;
			...
			class Controls
			{
				...
				class LineTop: LineLeft
				{
					...
					font="PuristaLight";
                    text="$STR_A3_RscDisplayMain_Spotlight_Play";
				};
		...
		class TextBackground: Life_RscPicture
		{
			idc=1029;
