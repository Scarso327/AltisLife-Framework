...
_trader addAction ["<t color='#B92DE0'>[Civilian]</t> Capture", { _this call ULP_fnc_capture }, [], 1, true, true, "", "isNull (objectParent _this) && { [_this, [""Civilian"", ""Dunamis""]] call ULP_fnc_isFaction }", 3];
