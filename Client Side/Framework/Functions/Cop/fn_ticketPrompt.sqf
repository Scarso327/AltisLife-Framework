...
CONTROL(2600,2601) ctrlSetStructuredText parseText format ["<t align='center'><t size='.8px'>" +("%1 has given you a ticket for £%2"),_cop getVariable ["realname",name _cop],_val];
