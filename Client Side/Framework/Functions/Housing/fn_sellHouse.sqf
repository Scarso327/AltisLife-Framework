...
if (isNil {_house getVariable "house_owner"}) exitWith {hint "There is no owner for this property.";};
closeDialog 0;
...
_action = [
    format ["Are you sure you want to sell your property? It will sell for: &lt;t color='#8cff9b'&gt;£%1&lt;/t&gt;",
