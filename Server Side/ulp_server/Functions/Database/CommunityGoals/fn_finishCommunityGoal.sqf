...
private _contributions = [format ["SELECT `pid`, `contribution` FROM `community_goal_contributions` WHERE `goalId` = '%1'", [_id, ""] call ULP_fnc_numberText], 2, true] call ULP_DB_fnc_asyncCall;
