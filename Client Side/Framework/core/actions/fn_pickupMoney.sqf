...
*/
private "_value";
if ((time - life_action_delay) < 1.5) exitWith {hint "You're doing it too fast!"; _this setVariable ["inUse",false,true];};
...
if (!isNil "_value") exitWith {
    ...
    titleText[format ["You have picked up £%1.",[_value] call life_fnc_numberText],"PLAIN"];
    CASH = CASH + _value;
