...
class U_C_CBRN_Suit_01_White_F {
	...
	class Textures {
		...
		class U_C_CBRN_Suit_01_Blue_F : U_B_CombatUniform_mcam { displayName = "Blue"; };
		class U_B_CBRN_Suit_01_MTP_F : U_B_CombatUniform_mcam { displayName = "MTP"; };
		class U_B_CBRN_Suit_01_Wdl_F : U_B_CombatUniform_mcam { displayName = "WDL"; };
