...
//Set Repair Action
_Btn1 ctrlSetText "Repair Vehicle";
...
if (playerSide isEqualTo west) then {
    ...
    _Btn3 ctrlSetText "Search Vehicle";
    ...
    if (_curTarget isKindOf "Ship") then {
        ...
        if (!isNil "_id") then {
            if !(_id in getDLCs 1) then {
                _Btn6 ctrlSetText "Get In Vehicle";
            ...
            _Btn6 ctrlSetText "Unflip Vehicle";
            _Btn6 buttonSetAction "life_vInact_curTarget spawn FF_fnc_unflipVehicle; closeDialog 0;";
    ...
    if (_curTarget isKindOf "Ship") then {
        ...
        if (!isNil "_id") then {
            if !(_id in getDLCs 1) then {
                _Btn2 ctrlSetText "Get In Vehicle";
            ...
            _Btn2 ctrlSetText "Unflip Vehicle";
            _Btn2 buttonSetAction "life_vInact_curTarget spawn FF_fnc_unflipVehicle; closeDialog 0;";
    ...
    if (typeOf _curTarget == "O_Truck_03_device_F") then {
        _Btn3 ctrlSetText "Mine from device";
