...
private _key = EXTDB format ["%1:%2:%3", _mode, FETCH_CONST(ULP_SQL_ID), _statement];
...
if ((_result select 0) isEqualTo 0) exitWith { [format ["extDB3: Protocol Error: %1", _result]] call ULP_fnc_logIt; []};
