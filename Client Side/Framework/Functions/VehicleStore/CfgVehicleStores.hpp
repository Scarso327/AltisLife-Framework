class CfgVehicleStores {
	...
	class PoliceAir : Base {
		...
		factions[] = { "Police" };
		class Vehicles {
			class B_UAV_01_F { condition = "[""Police_Main"", 8] call ULP_fnc_hasAccess || { [""Police_NPAS"", 1] call ULP_fnc_hasAccess } || { [""Police_SCO"", 1] call ULP_fnc_hasAccess } || { [""Police_NCA"", 1] call ULP_fnc_hasAccess }"; };
