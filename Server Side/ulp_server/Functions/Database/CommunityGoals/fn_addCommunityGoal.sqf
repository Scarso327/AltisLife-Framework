...
[str parseText format["INSERT INTO `community_goals` (`id`, `goal_cfg`, `end_date`) VALUES ('%1', '%2', DATE_FORMAT(ADDDATE(CURDATE(), INTERVAL %3 DAY), '&#37;Y-&#37;c-&#37;e'));", [_id, ""] call ULP_fnc_numberText, configName _goalCfg, [_duration, ""] call ULP_fnc_numberText], 1] call ULP_DB_fnc_asyncCall;
