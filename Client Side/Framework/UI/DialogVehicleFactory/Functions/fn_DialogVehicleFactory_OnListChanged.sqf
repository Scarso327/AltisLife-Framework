...
scopeName "fn_DialogVehicleFactory_OnListChanged";
...
private _info = _display displayCtrl 6205;
...
_itemCfg params [ "", "_missionCfg", "_picture", "_displayName" ];
...
_info ctrlSetStructuredText parsetext format [
	...
	_picture, 
	_displayName, 
	getText(_missionCfg >> "description"), 
	_requiredPower,
