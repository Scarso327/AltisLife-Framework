class CfgRandomEvents {
	...
	class PopupCartel : Airdrop {
		...
		class Events : Events {
			...
			class OnClaimed { code = "_this params [[""_message"", """", [""""]], [""_reward"", -1, [0]]]; [_reward, false, ""Popup Cartel""] call ULP_fnc_addMoney; [100, ""Captured Popup Cartel""] call ULP_fnc_addXP; [_message] call ULP_fnc_hint;"; };
		};
		class ServerFunctions : ServerFunctions {
