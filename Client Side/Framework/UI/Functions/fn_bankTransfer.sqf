...
if ((_value + _tax) > BANK) exitWith {hint format ["You do not have enough money in your bank account, to transfer £%1 you will need £%2 as a tax fee",_value,_tax]};
...
hint format ["You have transfered £%1 to %2.\n\nA tax fee of £%3 was taken for the wire transfer.",[_value] call life_fnc_numberText,_unit getVariable ["realname",name _unit],[_tax] call life_fnc_numberText];
