...
class WeaponShops {
    ...
    class cop_basic {
        ...
        items[] = {
            ...
            { "hgun_Pistol_heavy_01_F", "", 9500, 4750, "call Police_Main >= 1" },
            { "SMG_02_ACO_F", "", 30000, 15000, "call Police_Main >= 2" },
            { "arifle_MX_F", "", 35000, 17500, "call Police_Main >= 2" },
            { "hgun_ACPC2_F", "", 17500, 8750, "call Police_Main >= 3" },
            { "arifle_MXC_F", "", 30000, 15000, "call Police_Main >= 3" },
            { "srifle_DMR_07_blk_F", "", 32000, 16000, "call Police_Main >= 3" } //Apex DLC Sniper
        };
        mags[] = {
            { "16Rnd_9x21_Mag", "", 125, 60, "" },
            { "20Rnd_556x45_UW_mag", $STR_W_mags_TaserRifle, 125, 60, "" },
            { "11Rnd_45ACP_Mag", "", 130, 65, "call Police_Main >= 1" },
            { "30Rnd_65x39_caseless_mag", "", 130, 65, "call Police_Main >= 2" },
            { "30Rnd_9x21_Mag", "", 250, 125, "call Police_Main >= 2" },
            { "9Rnd_45ACP_Mag", "", 200, 100, "call Police_Main >= 3" },
            { "20Rnd_650x39_Cased_Mag_F", "", 200, 100, "call Police_Main >= 3" } //Apex DLC
        };
        accs[] = {
            { "muzzle_snds_L", "", 650, 325, "" },
            { "optic_MRD", "", 2750, 1375, "call Police_Main >= 1" },
            { "acc_flashlight_pistol", "", 250, 125, "call Police_Main >= 1" },//Pistol Flashlight
            { "acc_flashlight", "", 750, 375, "call Police_Main >= 2" },
            { "optic_Holosight", "", 1200, 600, "call Police_Main >= 2" },
            { "optic_Arco", "", 2500, 1250, "call Police_Main >= 2" },
            { "muzzle_snds_H", "", 2750, 1375, "call Police_Main >= 2" }
        };
    };
