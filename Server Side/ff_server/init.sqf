...
[8,true,12] execFSM "\ff_server\FSM\timeModule.fsm";
...
[] call compile preprocessFileLineNumbers "\ff_server\functions.sqf";
...
cleanupFSM = [] execFSM "\ff_server\FSM\cleanup.fsm";
