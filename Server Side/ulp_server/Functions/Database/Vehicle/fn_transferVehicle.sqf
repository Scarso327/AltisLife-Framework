...
[format["UPDATE `vehicles` SET `pid`='%1' WHERE `pid`='%2' AND `id`='%3' AND `active`='0' AND `sold`='0' AND `impound`='0'", _newSteamId, _steamId, [_vehicleId, ""] call ULP_fnc_numberText], 1] call ULP_DB_fnc_asyncCall;
