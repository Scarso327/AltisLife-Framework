...
_trigger setTriggerStatements ["this && { (vehicle player) in thisList }", "[""PopupCartel"", ""create"", true, thisTrigger getVariable ""popup_cartel""] call ULP_fnc_cartelHud", "[""PopupCartel"", ""remove""] call ULP_fnc_cartelHud"];
