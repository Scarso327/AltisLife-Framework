...
if (!(nearestObject [player, "House"] in life_vehicles)) exitWith {hint "You need to be inside your property to place this.";};
...
titleText ["Hit spacebar to place the container.", "PLAIN"];
