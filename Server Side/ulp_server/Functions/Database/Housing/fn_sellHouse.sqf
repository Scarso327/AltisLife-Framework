...
[format["UPDATE `houses` SET `sold`='1' WHERE `id`='%1'", [(_house getVariable ["building_id", -1]), ""] call ULP_fnc_numberText], 1] call ULP_DB_fnc_asyncCall;
...
["CALL deleteOldHouses", 1] call ULP_DB_fnc_asyncCall;
