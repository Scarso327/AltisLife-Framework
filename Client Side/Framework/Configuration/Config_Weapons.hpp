...
class WeaponShops {
    ...
    class cop_basic {
        ...
        items[] = {
            ...
            { "hgun_Pistol_heavy_01_F", "", 9500, 4750, "[""Police_Main"", 1] call ULP_fnc_hasAccess;" },
            { "SMG_02_ACO_F", "", 30000, 15000, "[""Police_Main"", 2] call ULP_fnc_hasAccess;" },
            { "arifle_MX_F", "", 35000, 17500, "[""Police_Main"", 2] call ULP_fnc_hasAccess;" },
            { "hgun_ACPC2_F", "", 17500, 8750, "[""Police_Main"", 3] call ULP_fnc_hasAccess;" },
            { "arifle_MXC_F", "", 30000, 15000, "[""Police_Main"", 3] call ULP_fnc_hasAccess;" },
            { "srifle_DMR_07_blk_F", "", 32000, 16000, "[""Police_Main"", 3] call ULP_fnc_hasAccess;" } //Apex DLC Sniper
        };
        mags[] = {
            { "16Rnd_9x21_Mag", "", 125, 60, "" },
            { "20Rnd_556x45_UW_mag", $STR_W_mags_TaserRifle, 125, 60, "" },
            { "11Rnd_45ACP_Mag", "", 130, 65, "[""Police_Main"", 1] call ULP_fnc_hasAccess;" },
            { "30Rnd_65x39_caseless_mag", "", 130, 65, "[""Police_Main"", 2] call ULP_fnc_hasAccess;" },
            { "30Rnd_9x21_Mag", "", 250, 125, "[""Police_Main"", 2] call ULP_fnc_hasAccess;" },
            { "9Rnd_45ACP_Mag", "", 200, 100, "[""Police_Main"", 3] call ULP_fnc_hasAccess;" },
            { "20Rnd_650x39_Cased_Mag_F", "", 200, 100, "[""Police_Main"", 3] call ULP_fnc_hasAccess;" } //Apex DLC
        };
        accs[] = {
            { "muzzle_snds_L", "", 650, 325, "" },
            { "optic_MRD", "", 2750, 1375, "[""Police_Main"", 1] call ULP_fnc_hasAccess;" },
            { "acc_flashlight_pistol", "", 250, 125, "[""Police_Main"", 1] call ULP_fnc_hasAccess;" },//Pistol Flashlight
            { "acc_flashlight", "", 750, 375, "[""Police_Main"", 2] call ULP_fnc_hasAccess;" },
            { "optic_Holosight", "", 1200, 600, "[""Police_Main"", 2] call ULP_fnc_hasAccess;" },
            { "optic_Arco", "", 2500, 1250, "[""Police_Main"", 2] call ULP_fnc_hasAccess;" },
            { "muzzle_snds_H", "", 2750, 1375, "[""Police_Main"", 2] call ULP_fnc_hasAccess;" }
        };
    };
