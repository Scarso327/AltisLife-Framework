...
if (_curTarget getVariable "NPC") exitWith {hint "This vehicle is protected by the server"};
...
if (!_isVehicle) then {
    ...
    if (_dice < 30) then {
        ...
        [0,"%1 was seen trying to lockpick a vehicle.",true,[profileName]] remoteExecCall ["life_fnc_broadcast",west];
