...
_playerData params ["", "", "", "_cash", "_bank", "_playtime", "", "_adminlevel", "", "", "", "_gear", "", "_prestige", "_level", "_xp", "", "", "", "", "", "_perks"];
...
_unit setVariable ["joinTime", time];
_unit setVariable ["playTime", _playtime];
