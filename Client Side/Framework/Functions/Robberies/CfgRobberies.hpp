class CfgRobberies {
	...
	class FuelStation {
		...
		factions[] = { "Civilian" };
		reward[] = { 50000, 85000 };
		leveling[] = { { 30, 50 }, "Robbed Fuel Station", 100 };
	...
	class Supermarket {
		...
		factions[] = { "Civilian" };
		reward[] = { 80000, 100000 };
		leveling[] = { { 40, 70 }, "Robbed Supermarket", 100 };
	...
	class Jewellery {
		...
		leveling[] = { { 50, 100 }, "Robbed Jewellery Store", 100 };
		condition = "[[""Police""]] call ULP_fnc_onlineFaction >= 4";
		onFail = "[""There must be at least <t color='#B92DE0'>4 officers</t> online to rob this site!""] call ULP_fnc_hint;";
	};
	...
	class RegionalBank {
		...
		leveling[] = { { 200, 300 }, "Robbed Regional Bank", 100 };
