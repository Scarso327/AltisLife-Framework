...
[format["UPDATE `houses` SET `upkeepDaysLeft`='%2' WHERE `id`='%1'", [_buildingId, ""] call ULP_fnc_numberText, [_newUpKeepDaysLeft, ""] call ULP_fnc_numberText], 1] call ULP_DB_fnc_asyncCall;
