class CfgFactions {
	...
	class Police {
		...
		class Whitelisting {
			...
			class RTA { queryIndex = 21; };
			class NPAS { queryIndex = 22; };
			class SCO { queryIndex = 23; };
			class NCA { queryIndex = 24; };
			class MPU { queryIndex = 25; };
			class RPU { queryIndex = 26; };
			class AFO { queryIndex = 27; };
			class UC { queryIndex = 28; };
		};
