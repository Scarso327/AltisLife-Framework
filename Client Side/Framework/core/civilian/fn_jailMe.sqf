...
switch (true) do {
    ...
    case (_esc): {
        life_is_arrested = false;
        hint "You have escaped from the HMP, you still retain your previous crimes and now have a count of escaping the HMP.";
        [0, "%1 has escaped from the HMP!", true, [profileName]] remoteExecCall ["life_fnc_broadcast", RCLIENT];
    ...
    case (alive player && {!_esc} && {!_bail}): {
        life_is_arrested = false;
        hint "You have served your time in the HMP and have been released.";
